...
const HERO_STYLES = {
  ...
  BG_WRAPPER:
    "absolute hero-bg right-0 md:bottom-[10px] bottom-[10px] -z-1 md:w-2/4 w-full scale-125 sm:scale-100 flex items-end",
  ...
  const renderHeroContent = (): React.ReactNode => (
    <div className={HERO_STYLES.CONTENT}>
      <div className="md:mb-4 mb-2">
        ...
        <h1 className="text-3xl seq">I am Hoang Thong</h1>
      </div>
      <p className="mb-4">
      ...
      <div className="flex seq">
        <Button
          ...
          href="/CV_NguyenHoangThong_New.pdf"
        ></Button>
        <Button
          classes="ml-3"
